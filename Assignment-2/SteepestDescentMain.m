...
%% αρχικό σημείο (0, 0)
[numbers1a, k1a] = SteepestDescentConst(grad_f, n1, e, gk1);
[numbers2a, k2a] = SteepestDescentArmijo(f, grad_f, n1, e);
[numbers3a, k3a] = SteepestDescentMinimum(f, grad_f, n1, e);

%% αρχικό σημείο (-1, 1)
[numbers1b, k1b] = SteepestDescentConst(grad_f, n2, e, gk1);
[numbers2b, k2b] = SteepestDescentArmijo(f, grad_f, n2, e);
[numbers3b, k3b] = SteepestDescentMinimum(f, grad_f, n2, e);

%% αρχικό σημείο (1, -1)
[numbers1c, k1c] = SteepestDescentConst(grad_f, n3, e, gk1);
[numbers2c, k2c] = SteepestDescentArmijo(f, grad_f, n3, e);
[numbers3c, k3c] = SteepestDescentMinimum(f, grad_f, n3, e);

%% Γραφική παράσταση συνάρτησης SteepestConst για όλα τα δοσμένα αρχικά σημεία
%%(0, 0)
x = linspace(-5, 5);
y = linspace(-5, 5);
[x, y] = meshgrid(x, y);
...
%% Γραφική παράσταση συνάρτησης SteepestArmijo για όλα τα δοσμένα αρχικά σημεία
%%(0, 0)
x = linspace(-5, 5);
y = linspace(-5, 5);
[x, y] = meshgrid(x, y);
...
%% Γραφική παράσταση συνάρτησης Steepest Minimum για όλα τα δοσμένα αρχικά σημεία
...
%% k statistics
disp("Steepest Const για τα αρχικά σημεία (0, 0), (-1, 1), (1, -1) αντίστοιχα " + k1a + ", " + k1b + ", " + k1c);
disp("Steepest Armijo για τα αρχικά σημεία (0, 0), (-1, 1), (1, -1) αντίστοιχα " + k2a + ", " + k2b + ", " + k2c);
disp("Steepest Minimum για τα αρχικά σημεία (0, 0), (-1, 1), (1, -1) αντίστοιχα " + k3a + ", " + k3b + ", " + k3c);
