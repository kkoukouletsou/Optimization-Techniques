function [] = GeneticAlgorithmMainPart2()
%a and c values
...
while true
    i = i + 1;
    chr2 = NextGeneration(chr1, sum, I, 2, chr1(1, 18));
    ...
    d1 = chr2(int2, :);
    d2 = chr2(int3, :);
    [chr2(int2, :), chr2(int3, :)] = Crossover(d1, d2, c, 2,chr2(int, 18));
...
disp("Value of V is " + chr2(10, 18));

%last check that all conditions are met
if Check(chr2(1, :), c, chr2(1, 18)) == 1
